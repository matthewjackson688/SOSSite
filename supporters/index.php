...
<body>
  ...
  <main class="wrap">
    <section class="card supporters-info">
      ...
      <ol class="supporters-list" type="i">
        ...
        <li>
          Whoever you are, please find us on our current social media outlets: Facebook, LinkedIn, and X.
  ...
  <footer class="wrap small footer">
    <div class="social-row">
      ...
      <a href="#" data-coming-soon-social="Instagram" aria-label="Instagram">
